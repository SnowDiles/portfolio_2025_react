...
function Navbar() {
    ...
    return (
        <div className="overflow-x-hidden ">
            ...
            >
                <ul className="text-white flex flex-row space-x-8 justify-end items-center h-[50px] ">
                    {element.map((item, index) => (
                        ...
                        >
                            <a href={`#${index}section`}><span className="text-[#63edd1] md:mr-2 justify-center text-center">0{index + 1}.</span><span className="pt-2">{item}</span></a>
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div 
                        className="md:hidden block h-screen bg-[#112240] w-[60%] max-w-full absolute right-0 p-5 text-sm z-10 flex items-center"
                        initial="hidden"
                        animate="visible"
                        exit="exit"
